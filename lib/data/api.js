...
class DevOps {
    ...
    User = class User {
        ...
        static clear() {
            DevOps.instance.User.#instance = null
        }
        ...
        static async getCurrentUser(refresh = false) {
            ...
            try {
                ...
                if (refresh || null == DevOps.instance.User.#instance) {
                    ...
                    currentOrganization = (currentOrganization ?? organizations.value[0])?.accountName
        ...
        async setCurrentOrganization(name) {
            ...
            configuration.update('organization.default', this.organization.current, true)
