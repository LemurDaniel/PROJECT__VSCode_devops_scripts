...
class ProjectViewDataProvider {
    ...
    static ProjectView = class ProjectViewItem extends vscode.TreeItem {
    ...
    static RepositoryView = class ProjectViewItem extends vscode.TreeItem {
    ...
    async getTreeItem(element) {
        if (element instanceof Project) {
            ...
            return new ProjectViewDataProvider.ProjectView(element.name, avatar)
        }
        else {
            return new ProjectViewDataProvider.RepositoryView(element.name)
        }
    }
...
async function postTest() {
    ...
    await interaction.userPickTeamByProject()
    return
    try {
