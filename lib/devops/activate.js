...
function activate(context) {
    ...
    disposable = vscode.commands.registerCommand("devopsscripts.repository.create", project => createRepository(project))
    context.subscriptions.push(disposable)
...
async function createRepository(project) {
    ...
    try {
        const repository = await project.createRepository(repositoryName)
