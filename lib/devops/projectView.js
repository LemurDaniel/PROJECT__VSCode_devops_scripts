...
class ProjectView {
    ...
    async getChildren(element) {
        ...
        if (null == element) {
            ...
            return [
                new Folder('Pipelines', element.pipelines.then(
            ...
            // Create full array of Promises, then await all, since folder content might be Promises or not.
            const elements = element.all.map(val => val instanceof Promise ? val : new Promise(resolve => resolve(val)))
